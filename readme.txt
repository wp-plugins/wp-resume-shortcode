...
* dateseparator : optional, default is "<br />".
...
* lineseparator : optional, default is "<br />".
...
* Addition of new parameters : dateseparator and lineseparator. HTML allowed (<br />, -, ...). Default is <br />.